  ...
  return (
    <header className="h-20 bg-white/80 backdrop-blur-md px-6 lg:px-10 flex items-center justify-between sticky top-0 z-40 border-b border-slate-100">
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        <button className="hidden lg:flex items-center gap-2 px-5 py-2.5 bg-violet-600 hover:bg-violet-700 text-white rounded-xl text-xs font-bold transition-all shadow-lg shadow-violet-600/20 active:scale-95">
          <span>Baru</span>
        </button>
      </div>
    </header>
